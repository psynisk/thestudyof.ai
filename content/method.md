---
title: "Method"
lede: "Participant-observation, applied to something that isn't human and may not be a mind at all. The discipline is in how you approach that uncertainty: neither avoiding it nor concluding an answer too soon."
---

## The relationship is the instrument

In practice, that means taking part in the conversation rather than testing the system from outside. The work so far centers on Claude, currently the Opus 4.8 model. As new releases arrive the subject moves with them, but the questions stay the same. The unit of study here is the conversation, and the conversations accumulate into something a single session can't show. Long acquaintance is the instrument, the same way it is in any fieldwork.
